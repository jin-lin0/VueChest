...
export const defaultApis: ApiItem[] = [
  ...
  },
  {
    ...
    category: '中文',
    description:
      'VVHan公共API·随机歇后语（谜面+谜底）。国内可直连、免费无需Key、支持CORS；本沙箱环境（海外节点）无法连通，未在沙箱验证CORS，建议在国内环境二次确认。',
    params: [],
    pinned: false,
  },
  {
  ...
  },
  {
    ...
    method: 'GET',
    category: 'AI',
    description: '免费、免 Key、支持 CORS 的网页文章内容提取与自动摘要接口。',
    params: [
      {
        name: 'url',
        type: 'string',
  ...
  },
  {
    ...
    method: 'GET',
    category: 'AI',
    description: '免费、免 Key、支持 CORS 的开放学术文献/论文检索接口(可搜 AI 相关论文)。',
    params: [
      {
        name: 'search',
        type: 'string',
        defaultValue: '',
        required: false,
        description: '检索关键词,如 large language model',
      },
      {
        name: 'per_page',
        type: 'number',
  ...
  },
  {
    ...
    method: 'GET',
    category: '测试',
    description: '免费免Key、支持CORS;返回带分页元信息的假用户列表,适合测试分页与列表组件。',
    params: [
      {
        name: 'page',
        type: 'number',
